...
/**
 * A custom Db2 implementation of {@link ZonedTimestampType}.
 *
 * @author Chris Cranford
 */
class Db2ZonedTimestampType extends ZonedTimestampType {

    public static final Db2ZonedTimestampType INSTANCE = new Db2ZonedTimestampType();
    ...
    public void bind(Query<?> query, int index, Schema schema, Object value) {
        if (value == null) {
            ...
            // Writing the value to Db2 using ZonedDateTime like other dialects seems to lead to
