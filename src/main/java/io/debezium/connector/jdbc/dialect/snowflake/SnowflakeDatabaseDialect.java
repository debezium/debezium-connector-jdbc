...
import tech.paramount.SnowflakeDialect;
...
public class SnowflakeDatabaseDialect extends GeneralDatabaseDialect {
    ...
    public String getUpsertStatement(TableDescriptor table, SinkRecordDescriptor record) {
        ...
        if (!record.getNonKeyFieldNames().isEmpty()) {
            ...
            builder.appendList(",", record.getNonKeyFieldNames(), (name) -> getUpsertIncomingClause(name, record));
        }
    ...
    private String getUpsertIncomingClause(String fieldName, SinkRecordDescriptor record) {
